...
public class CustomerController {
  ...
  @ResponseBody
  public List<ATrainingBundle> findBundles(
      @PathVariable Long id, @RequestParam(required = false) Long specId) {
    Stream<ATrainingBundle> bundles =
        service.findById(id).getTrainingBundles().stream()
