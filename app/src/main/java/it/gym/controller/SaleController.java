...
public class SaleController {
  ...
  public ResponseEntity<SaleResource> findSaleById(@PathVariable Long id) {
    ...
    return new ResponseEntity<>(
        new SaleAssembler().toModel(sale), HttpStatus.OK);
  }

  @GetMapping(path = "/findByCustomer")
  @ResponseBody
  public Page<SaleResource> findUserSales(
      ...
      Pageable pageable) {
    return facade
        .findAllUserSales(id, date, payed, pageable)
        .map(SaleResource::new);
  }

  @GetMapping
  @ResponseBody
  public Page<SaleResource> findAll(
      @RequestParam(required = false) Boolean payed, Pageable pageable) {
  ...
  public Page<SaleResource> findSalesByLastNameAndDate(
      ...
      Pageable pageable) {
    return facade
        .getSales(lastName, date, payed, pageable)
        .map(SaleResource::new);
  }

  @PostMapping
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<SaleResource> createSale(
  ...
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<SaleResource> addSalesLineItem(
  ...
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<SaleResource> deleteSalesLineItem(
      @PathVariable Long saleId, @PathVariable Long salesLineItemId) {
  ...
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<SaleResource> pay(
      @PathVariable Long saleId, @RequestParam Double amount) {
  ...
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<SaleResource> deletePayment(
      @PathVariable Long saleId, @PathVariable Long paymentId) {
