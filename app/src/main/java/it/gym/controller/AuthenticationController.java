...
public class AuthenticationController {
  ...
  public ResponseEntity<AUserResource> registration(
      @Valid @RequestBody AUser user) {
  ...
  public ResponseEntity<AUserResource> confirmRegistration(
    ...
    return new ResponseEntity<>(
        new AUserAssembler().toModel(user), HttpStatus.OK);
  }

  @PostMapping("/changePasswordAnonymous/{id}")
  @PreAuthorize("isAnonymous()")
  public ResponseEntity<AUserResource> changePasswordAnonymous(
  ...
  public ResponseEntity<AUserResource> changePassword(
      @PathVariable Long id, @RequestBody PasswordForm form) {
    AUser user = this.facade.changePassword(id, form);
    return new ResponseEntity<>(
        new AUserAssembler().toModel(user), HttpStatus.OK);
  ...
  @PreAuthorize("isAnonymous()")
  public ResponseEntity<AUserResource> getUserFromVerificationToken(
  ...
  @PreAuthorize("isAnonymous()")
  public ResponseEntity<AUserResource> forgotPassword(
  ...
  @PreAuthorize("isAuthenticated()")
  public ResponseEntity<AUserResource> resendTokenAnonymous(
  ...
  @PreAuthorize("isAnonymous()")
  public ResponseEntity<AUserResource> resendToken(
