...
public abstract class AEvent implements Serializable {
  ...
  @Id
  @SequenceGenerator(
      name = "events_event_id_seq",
      sequenceName = "events_event_id_seq",
      allocationSize = 1)
  @GeneratedValue(
      strategy = GenerationType.SEQUENCE,
      generator = "events_event_id_seq")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, aEvent.id) && Objects.equals(name, aEvent.name);
  }
