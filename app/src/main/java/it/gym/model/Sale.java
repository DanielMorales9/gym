...
public class Sale implements Serializable, Eager<Sale> {
  ...
  @Id
  @SequenceGenerator(
      name = "sales_sale_id_seq",
      sequenceName = "sales_sale_id_seq",
      allocationSize = 1)
  @GeneratedValue(
      strategy = GenerationType.SEQUENCE,
      generator = "sales_sale_id_seq")
  @Column(name = "sale_id")
  private Long id;
  ...
  public boolean isPayed() {
    return amountPayed.equals(getTotalPrice())
  ...
  public boolean confirm() {
    if (this.salesLineItems == null) return false;
    if (this.salesLineItems.size() == 0) return false;
