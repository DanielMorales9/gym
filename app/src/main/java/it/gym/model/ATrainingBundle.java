...
public abstract class ATrainingBundle
    implements Comparable<ATrainingBundle>,
        Serializable,
        Eager<ATrainingBundle> {

  @Id
  @SequenceGenerator(
      name = "bundles_bundle_id_seq",
      sequenceName = "bundles_bundle_id_seq",
      allocationSize = 1)
  @GeneratedValue(
      strategy = GenerationType.SEQUENCE,
      generator = "bundles_bundle_id_seq")
