...
public class Customer extends AUser {
  ...
  public List<ATrainingBundle> getTrainingBundles() {
    if (trainingBundles == null) this.trainingBundles = new ArrayList<>();
  ...
  public List<Role> defaultRoles() {
    return Collections.singletonList(new Role(3L, "CUSTOMER"));
  }
  ...
  public boolean isActive() {
    if (this.trainingBundles != null) return !this.trainingBundles.isEmpty();
    else return false;
  }
}
