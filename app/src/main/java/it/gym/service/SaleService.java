...
public class SaleService implements ICrudService<Sale, Long> {
  ...
  public Sale findById(Long sale) {
    return this.saleRepository
        .findById(sale)
        .orElseThrow(() -> new NotFoundException("Vendita", sale));
  }
  ...
  public Page<Sale> getSales(
    ...
    if (date != null && lastName != null) {
      page =
          findSalesByCustomerLastNameAndCreatedAtGreaterThanEqual(
              lastName, date, payed, pageable);
  ...
  public Page<Sale> findAllUserSales(
    ...
    if (date != null) {
      page =
          this.findSalesByCustomerIdAndCreatedAtGreaterThanEqual(
              id, date, payed, pageable);
    } else {
  ...
  public Page<Sale> findSalesByCustomerLastName(
      String lastName, Boolean payed, Pageable pageable) {
    if (payed == null) {
      return saleRepository.findSalesByCustomerLastNameContains(
          lastName, pageable);
    } else if (payed) {
      return saleRepository.findSalesByCustomerLastNameAndIsPayed(
          lastName, pageable);
    } else {
      return saleRepository.findSalesByCustomerLastNameAndIsNotPayed(
          lastName, pageable);
    }
  }

  public Page<Sale> findSalesByCustomerLastNameAndCreatedAtGreaterThanEqual(
      String lastName, Date date, Boolean payed, Pageable pageable) {
    if (payed == null) {
      return saleRepository
          .findSalesByCustomerLastNameContainsAndCreatedAtGreaterThanEqual(
              lastName, date, pageable);
    } else if (payed) {
      return saleRepository
          .findSalesByCustomerLastNameAndCreatedAtGreaterThanEqualAndIsPayed(
              lastName, date, pageable);
    } else {
      return saleRepository
          .findSalesByCustomerLastNameAndCreatedAtGreaterThanEqualAndIsNotPayed(
              lastName, date, pageable);
    }
  }

  public Page<Sale> findSalesByCreatedAtGreaterThanEqual(
      Date date, Boolean payed, Pageable pageable) {
    if (payed == null) {
      return saleRepository.findSalesByCreatedAtGreaterThanEqual(
          date, pageable);
    } else if (payed) {
      return saleRepository.findSalesByCreatedAtGreaterThanEqualAndIsPayed(
          date, pageable);
    } else {
      return saleRepository.findSalesByCreatedAtGreaterThanEqualAndIsNotPayed(
          date, pageable);
    }
  }
  ...
  public Page<Sale> findUserSales(Long id, Boolean payed, Pageable pageable) {
    if (payed == null) return this.saleRepository.findUserSales(id, pageable);
    else if (payed) {
  ...
  public Page<Sale> findSalesByCustomerIdAndCreatedAtGreaterThanEqual(
      Long id, Date date, Boolean payed, Pageable pageable) {
    if (payed == null) {
      return saleRepository.findSalesByCustomerIdAndCreatedAtGreaterThanEqual(
          id, date, pageable);
    } else if (payed) {
      return saleRepository
          .findSalesByCustomerIdAndCreatedAtGreaterThanEqualAndIsPayed(
              id, date, pageable);
    } else {
      return saleRepository
          .findSalesByCustomerIdAndCreatedAtGreaterThanEqualAndIsNotPayed(
              id, date, pageable);
    }
  }
