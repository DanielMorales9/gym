...
@Service
@Transactional
public class TrainingBundleSpecificationService
    implements ICrudService<ATrainingBundleSpecification, Long> {
  ...
  public Page<ATrainingBundleSpecification> search(
    ...
    if (disabled == null && name == null) page = this.findAll(pageable);
  ...
  public List<ATrainingBundleSpecification> list(
    ...
    if (disabled == null) bundles = this.findAll();
    else bundles = this.findByIsDisabled(disabled);
  ...
  private List<ATrainingBundleSpecification> initAssociationList(
      List<ATrainingBundleSpecification> bundles) {
    return bundles.stream()
        .map(ATrainingBundleSpecification::eager)
        .collect(Collectors.toList());
  }
  ...
  public Page<ATrainingBundleSpecification> findByIsDisabled(
  ...
  public Page<ATrainingBundleSpecification> findByNameAndIsDisabled(
      String name, Boolean disabled, Pageable pageable) {
  ...
  private Page<ATrainingBundleSpecification> initAssociation(
      Page<ATrainingBundleSpecification> page) {
