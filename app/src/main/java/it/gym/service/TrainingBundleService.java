...
public class TrainingBundleService
    implements ICrudService<ATrainingBundle, Long> {
  ...
  @Caching(
      put = {
        @CachePut(
            value = "bundles-single",
            key = "#result.id",
            condition = "#result != null")
      },
      evict = {@CacheEvict(value = "bundles-all", allEntries = true)})
  ...
  public Page<ATrainingBundle> search(
      Long specId, Boolean expired, Date time, Pageable pageable) {
  ...
  public List<ATrainingBundle> findBundlesBySpec(
  ...
  public Page<ATrainingBundle> findBundlesByExpiredAtGreaterThan(
      Date time, Pageable pageable) {
    return repository.findBundlesByExpiredAtGreaterThan(time, pageable);
  }

  public Page<ATrainingBundle> findBundlesByCreatedAtGreaterThan(
      Date time, Pageable pageable) {
