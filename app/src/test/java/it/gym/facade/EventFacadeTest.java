...
public class EventFacadeTest {
  ...
  @MockBean private EventService service;
  ...
  public void whenCreateHoliday() {
    ...
    Mockito.doReturn(true)
        .when(gymService)
        .isWithinWorkingHours(any(), any(), any());
    Mockito.doAnswer(
            invocationOnMock -> {
  ...
  public void whenCreateEvent() {
    ...
    CourseTrainingEvent evt =
        (CourseTrainingEvent) facade.createCourseEvent(1L, event);
  ...
  public void editHoliday() {
    ...
    Mockito.doReturn(true)
        .when(gymService)
        .isWithinWorkingHours(any(), any(), any());
    Mockito.doReturn(createHoliday(1L, "'holiday", start, end))
        .when(service)
        .findById(1L);
  ...
  public void whenCreateTimeOff() {
    ...
    Mockito.verify(gymService).findById(1L);
    assertThat(evt)
        .isEqualTo(createTimeOff(1L, "timeOff", start, end, trainer));
  }
  ...
  public void editTimeOff() {
    ...
    Mockito.doReturn(gym).when(gymService).findById(1L);
    Mockito.doReturn(createTimeOff(1L, "timeOff", start, end, trainer))
        .when(service)
        .findById(2L);
    Mockito.doReturn(true)
        .when(gymService)
    ...
    Mockito.verify(gymService).findById(1L);
    assertThat(evt)
        .isEqualTo(createTimeOff(1L, "timeOff", start, newEnd, trainer));
  }
  ...
  private class CourseEventFixture {
    ...
    public CourseEventFixture invoke(Date start) {
      ...
      fixtureEvent =
          createCourseEvent(1L, "CourseEvent", start, addHours(start, 1), spec);
