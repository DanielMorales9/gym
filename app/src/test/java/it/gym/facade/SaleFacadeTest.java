...
public class SaleFacadeTest {
  ...
  public void addSalesLineItem() {
    ...
    PersonalTrainingBundleSpecification mockBundleSpec =
  ...
  public void addCourseBundleToSalesLineItem() {
    ...
    double price = 100.0;
    List<APurchaseOption> options =
        createSingletonTimePurchaseOptions(1, price, null);
    CourseTrainingBundleSpecification bundleSpec =
  ...
  public void confirmSale() {
    ...
    List<APurchaseOption> options =
        createSingletonBundlePurchaseOptions(30, 900.0, null);
    addSalesLineItem(
        mockSale, createPersonalBundleSpec(1L, "personal", options));
  ...
  public void deleteSalesLineItem() {
    ...
    PersonalTrainingBundleSpecification personalBundleSpec =
        createPersonalBundleSpec(1L, "personal", options);
    SalesLineItem mockSalesLineItem =
  ...
  public void deleteSaleByIdNonDeletable() {
    ...
    List<APurchaseOption> options =
        createSingletonBundlePurchaseOptions(30, 900.0, null);
    PersonalTrainingBundleSpecification bundleSpec =
        createPersonalBundleSpec(1L, "personal", options);

    addSalesLineItem(mockSale, bundleSpec);
    ATrainingBundle trainingBundle =
        mockSale.getSalesLineItems().get(0).getTrainingBundle();

    Date start = addDays(getNextMonday(), -8);
    Date end = addHours(start, 1);
    PersonalTrainingEvent event =
        createPersonalEvent(1L, "personal", start, end);
  ...
  public static SalesLineItem addSalesLineItem(
      Sale mockSale, ATrainingBundleSpecification specs) {
