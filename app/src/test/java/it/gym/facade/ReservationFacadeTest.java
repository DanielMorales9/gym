...
public class ReservationFacadeTest {
  ...
  private final PersonalTrainingEventFixture personalEventFixture =
      new PersonalTrainingEventFixture();
  private final CourseTrainingEventFixture courseEventFixture =
  ...
  public void whenCustomerCreateReservationFromBundle() {
    ...
    Mockito.doAnswer(
        ...
        .when(sessionService)
        .save(any(PersonalTrainingSession.class));
    Mockito.doAnswer(
            invocationOnMock -> {
        ...
        .when(eventService)
        .save(any(PersonalTrainingEvent.class));
    Mockito.doAnswer(invocationOnMock -> invocationOnMock.getArgument(0))
        .when(bundleService)
        .save(any(ATrainingBundle.class));
  ...
  public void whenCreatingReservationFromEventThenReturnsNotReservable() {
    ...
    Mockito.doAnswer(
        ...
        .when(sessionService)
        .save(any(CourseTrainingSession.class));
    Mockito.doAnswer(invocationOnMock -> invocationOnMock.getArgument(0))
        .when(bundleService)
        .save(any(ATrainingBundle.class));

    facade.createReservationWithExistingEvent(
        gym.getId(), customer.getId(), event.getId(), course.getId(), "ADMIN");
  ...
  public void
      whenCreatingReservationFromEventWithoutBundleThenReturnsBadRequest() {
  ...
  public void whenAdminDeleteReservationToPersonalTrainingEvent() {
    ...
    Reservation actual =
        facade.deleteReservation(1L, 1L, gymId, customer.getEmail(), "ADMIN");
  ...
  public void whenCustomerDeletesReservationToPersonalTrainingEvent() {
    ...
    Reservation actual =
        facade.deleteReservation(1L, 1L, gymId, null, "CUSTOMER");
  ...
  public void whenAdminDeleteReservationToCourseTrainingEvent() {
    ...
    ATrainingEvent event =
        createCourseEvent(1L, "course", start, end, bundle.getBundleSpec());
    ...
    Reservation actual =
        facade.deleteReservation(1L, 1L, gym.getId(), email, "ADMIN");
  ...
  private static class PersonalTrainingEventFixture {
    ...
    public void invoke(int numSessions1, double price1) {
      ...
      List<APurchaseOption> options =
          createSingletonBundlePurchaseOptions(numSessions1, price1, null);
      PersonalTrainingBundleSpecification spec =
          createPersonalBundleSpec(1L, "personal", options);
      APurchaseOption option = spec.getOptions().get(0);
