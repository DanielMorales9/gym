...
public class ReservationControllerIntegrationTest
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(ReservationControllerIntegrationTest.class);
  ...
  private final PersonalTrainingEventFixture personalTrainingEventFixture =
      new PersonalTrainingEventFixture();
  private final CourseTrainingEventFixture courseTrainingEventFixture =
      new CourseTrainingEventFixture();

  @Test
  public void whenCreateReservationFromBundleWithBundlePurchaseOptionReturnsOK()
      throws Exception {
    PersonalTrainingEventFixture fixture =
        personalTrainingEventFixture.invoke(
            14, false, false, 1, 100.0, 30, 100.0, 1, 10.0, 0);
  ...
  @Test
  public void
      whenCreateReservationFromBundleWithOnDemandPurchaseOptionReturnsOK()
          throws Exception {
    PersonalTrainingEventFixture fixture =
        personalTrainingEventFixture.invoke(
            14, false, false, 1, 100.0, 30, 100.0, 1, 10.0, 2);
  ...
  public void whenConfirmCourseEventReservationReturnsOK() throws Exception {
    courseTrainingEventFixture.invoke(
        0, true, true, 0, 1, 100.0, 30, 100.0, 1, 10.0, 11);
    Reservation reservation = courseTrainingEventFixture.getReservation();

    ResultActions result =
        mockMvc
            .perform(get("/reservations/" + reservation.getId() + "/confirm"))
            .andExpect(status().isOk());
  ...
  public void whenConfirmPersonalEventReservationReturnsOK() throws Exception {
    personalTrainingEventFixture.invoke(
        0, true, true, 1, 100.0, 30, 100.0, 1, 10.0, 1);
  ...
  public void whenDeleteReservationOnCourseEventReturnsOK() throws Exception {
    ...
    CourseTrainingEvent actualEvent =
        (CourseTrainingEvent) eventRepository.findById(event.getId()).get();
  ...
  public void whenDeleteReservationOnPersonalEventThenOK() throws Exception {
    ...
    Reservation reservation = personalTrainingEventFixture.getReservation();
    PersonalTrainingEvent event =
        personalTrainingEventFixture.getPersonalEvent();
    ...
    assertThat(bundleRepository.findAll().get(0))
        .isEqualTo(personalTrainingEventFixture.getBundle());
  ...
  private class CourseTrainingEventFixture {
    ...
    public void invoke(
      ...
      List<APurchaseOption> options =
          createAllOptions(
              number1, price1, number2, price2, number3, price3, null);
      CourseTrainingBundleSpecification spec =
          createCourseBundleSpec(1L, "course", maxCustomers, options);
  ...
  private class PersonalTrainingEventFixture {
    ...
    public PersonalTrainingEventFixture invoke(
        int days,
        boolean hasReservation,
        boolean hasEvent,
        int number1,
