...
public class VerificationTokenServiceTest {
  ...
  @Autowired private VerificationTokenService service;
  ...
  public void save() {
    this.service.save(
        createToken(
            1L,
            "ababa",
            createAdmin(1L, "admin@admin.com", null),
            addHours(new Date(), 2)));
  ...
  public void findById() {
    ...
    Mockito.when(repository.findById(1L))
        .thenAnswer(invocationOnMock -> Optional.of(token));
  ...
  public void findAll() {
    ...
    Mockito.when(repository.findAll())
        .thenAnswer(invocationOnMock -> Collections.singletonList(token));
  ...
  public void findByToken() {
    VerificationToken token =
        createToken(
            ...
            createAdmin(1L, "admin@admin.com", null),
            addHours(new Date(), 2));
    Mockito.when(repository.findByToken("ababa"))
        .thenAnswer(invocationOnMock -> Optional.of(token));
  ...
  public void findByUser() {
    VerificationToken token =
        createToken(
            ...
            addHours(new Date(), 2));
    Mockito.when(
            repository.findByUser(createAdmin(1L, "admin@admin.com", null)))
        .thenAnswer(invocationOnMock -> Optional.of(token));
    VerificationToken vk =
        this.service.findByUser(createAdmin(1L, "admin@admin.com", null));
    assertThat(vk).isEqualTo(token);
  ...
  public void existsByUser() {
    ...
    Mockito.when(
        ...
        .thenAnswer(invocationOnMock -> Optional.of(token));
    boolean exists =
        this.service.existsByUser(createAdmin(1L, "admin@admin.com", null));
  ...
  public void createOrChangeVerificationToken() {
    VerificationToken vk =
        this.service.createOrChangeVerificationToken(
            createAdmin(1L, "admin@admin.com", null));
    Mockito.verify(repository).findByUser(any(AUser.class));
  }
