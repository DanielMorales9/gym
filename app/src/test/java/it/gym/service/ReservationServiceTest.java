...
public class ReservationServiceTest {
  ...
  @MockBean private ReservationRepository repository;
  ...
  public void deleteAll() {
    ...
    List<Reservation> list =
        Collections.singletonList(createReservation(1L, customer));
  ...
  //        List<Reservation> toBeReturned =
  // Collections.singletonList(createReservation());
  //
  // Mockito.doReturn(toBeReturned).when(repository).findByInterval(any(),
  // any(), any());
  //        List<Reservation> list = service.findByIntervalAndId(1L, startTime,
  // endTime);
  ...
  // Collections.singletonList(createReservation());
  //
  // Mockito.doReturn(toBeReturned).when(repository).findByInterval(startTime,
  // endTime);
  ...
  public void findAll() {
    List<Reservation> toBeReturned =
        Collections.singletonList(createReservation(1L, null));
