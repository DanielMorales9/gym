...
public class RoleServiceTest {
  ...
  @MockBean private RoleRepository repository;
  ...
  public void findById() {
    Mockito.when(repository.findById(1L))
        .thenAnswer(invocationOnMock -> Optional.of(createAdminRole()));
  ...
  public void findAll() {
    Mockito.when(repository.findAll())
        .thenAnswer(
            invocationOnMock -> Collections.singletonList(createAdminRole()));
