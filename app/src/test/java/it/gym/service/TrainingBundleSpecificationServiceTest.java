...
public class TrainingBundleSpecificationServiceTest {
  ...
  @MockBean private TrainingBundleSpecificationRepository repository;
  ...
  public void findById() {
    ...
    Mockito.when(repository.findById(1L))
        .thenAnswer(invocationOnMock -> Optional.of(spec));
  ...
  public void findAll() {
    ...
    Mockito.when(repository.findAll())
        .thenAnswer(
            invocationOnMock -> Collections.singletonList(personalBundleSpec));
  ...
  public void delete() {
    List<APurchaseOption> options =
        createSingletonBundlePurchaseOptions(30, 900.0, null);
    ATrainingBundleSpecification u =
        createPersonalBundleSpec(1L, "personal", options);
