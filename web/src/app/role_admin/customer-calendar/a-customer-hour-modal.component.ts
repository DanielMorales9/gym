...
@Component({
    templateUrl: './a-customer-hour-modal.component.html',
    styleUrls: ['../../styles/root.css']
})
export class ACustomerHourModalComponent extends BaseCalendarModal implements OnInit {
    form: FormGroup;

    constructor(public dialogRef: MatDialogRef<ACustomerHourModalComponent>,
